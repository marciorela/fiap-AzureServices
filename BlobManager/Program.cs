...
{
    private const string blobServiceEndpoint = "https://mediastorrela.blob.core.windows.net/";
    private const string storageAccountName = "mediastorrela";
    private const string storageAccountKey = "eVufy5wHVB3WyddVEHHW/zORFf4yW8yGFs6cip6zDiWSaIdMOzEKcDSEpQ+Njik20sVS7hEPB3xk+AStaytRvw==";
